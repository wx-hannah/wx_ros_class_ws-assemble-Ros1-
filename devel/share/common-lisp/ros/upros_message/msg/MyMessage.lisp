...
(cl:defmethod cl:initialize-instance :after ((m <MyMessage>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'MyMessage)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name upros_message-msg:<MyMessage> is deprecated: use upros_message-msg:MyMessage instead.")))

(cl:ensure-generic-function 'key-val :lambda-list '(m))
(cl:defmethod key-val ((m <MyMessage>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader upros_message-msg:key-val is deprecated.  Use upros_message-msg:key instead.")
  (key m))

(cl:ensure-generic-function 'value-val :lambda-list '(m))
(cl:defmethod value-val ((m <MyMessage>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader upros_message-msg:value-val is deprecated.  Use upros_message-msg:value instead.")
  (value m))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<MyMessage>)))
  ...
  (cl:format cl:nil "int32 key    # an integer field~%string value   # a string field~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'MyMessage)))
  "Returns full string definition for message of type 'MyMessage"
  (cl:format cl:nil "int32 key    # an integer field~%string value   # a string field~%~%~%"))
