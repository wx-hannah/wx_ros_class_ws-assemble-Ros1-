...
"""autogenerated by genpy from upros_message/CoreMoveActionGoal.msg. Do not edit."""
import codecs
import sys
...
class CoreMoveActionGoal(genpy.Message):
  _md5sum = "f44fb06e8a4ea84c262849dc29ccc1c9"
  _type = "upros_message/CoreMoveActionGoal"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalID','upros_message/CoreMoveGoal']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(CoreMoveActionGoal, self).__init__(*args, **kwds)
      ...
      if self.goal is None:
        self.goal = upros_message.msg.CoreMoveGoal()
    else:
      self.header = std_msgs.msg.Header()
      self.goal_id = actionlib_msgs.msg.GoalID()
      self.goal = upros_message.msg.CoreMoveGoal()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self
      buff.write(_get_struct_b3I().pack(_x.goal.cmd, _x.goal.target_pose.header.seq, _x.goal.target_pose.header.stamp.secs, _x.goal.target_pose.header.stamp.nsecs))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.goal.cmd, _x.goal.target_pose.header.seq, _x.goal.target_pose.header.stamp.secs, _x.goal.target_pose.header.stamp.nsecs,) = _get_struct_b3I().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
