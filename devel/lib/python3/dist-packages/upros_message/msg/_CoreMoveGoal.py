...
"""autogenerated by genpy from upros_message/CoreMoveGoal.msg. Do not edit."""
import codecs
import sys
...
class CoreMoveGoal(genpy.Message):
  _md5sum = "c1e16158e8d38eb2844c9923667d0a0c"
  _type = "upros_message/CoreMoveGoal"
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(CoreMoveGoal, self).__init__(*args, **kwds)
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_get_struct_b3I().pack(_x.cmd, _x.target_pose.header.seq, _x.target_pose.header.stamp.secs, _x.target_pose.header.stamp.nsecs))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.cmd, _x.target_pose.header.seq, _x.target_pose.header.stamp.secs, _x.target_pose.header.stamp.nsecs,) = _get_struct_b3I().unpack(str[start:end])
      start = end
      end += 4
